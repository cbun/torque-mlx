...
def test_qwen_mlx_generation_result_serializes_runtime_profile() -> None:
    result = QwenMLXGenerationResult(
        ...
        runtime_profile=QwenMLXRuntimeProfile(
            ...
            converted_attention_seconds=0.21,
            converted_attention_calls=6,
            converted_attention_tokens=48,
            passthrough_attention_seconds=0.31,
            passthrough_attention_calls=10,
            passthrough_attention_tokens=80,
            linear_layer_seconds=0.41,
            linear_layer_calls=12,
            linear_layer_tokens=96,
